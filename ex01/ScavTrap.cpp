...
/*   Updated: 2024/09/12 13:15:54 by akuburas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap() : ClapTrap()
{
	...
	std::cout << "\033[1;91mDefault ScavTrap " << this->_name << " has been created!\033[0m" << std::endl;
}
...
void ScavTrap::guardGate(void)
{
	if (this->_energyPoints < 1 || this->_hitpoints < 1)
		std::cout << "\033[1;91mScavTrap " << this->_name << " is out of hitpoints or energy points!\033[0m" << std::endl;
	else
